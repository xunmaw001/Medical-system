    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药品价格" prop="yaopinNewMoney">
                       <el-input v-model="ruleForm.yaopinNewMoney"
                                 placeholder="药品价格" clearable  :readonly="ro.yaopinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="药品价格" prop="yaopinNewMoney">
                           <el-input v-model="ruleForm.yaopinNewMoney"
