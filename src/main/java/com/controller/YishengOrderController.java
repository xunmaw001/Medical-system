...
//            yishengOrder.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R shenhe(@RequestBody YishengOrderEntity yishengOrder, HttpServletRequest request){
        logger.debug("shenhe方法:,,Controller:{},,yishengOrder:{}",this.getClass().getName(),yishengOrder.toString());

//        if(yishengOrder.getYishengOrderYesnoTypes() == 2){//通过
//            yishengOrder.setYishengOrderTypes();
//        }else if(yishengOrder.getYishengOrderYesnoTypes() == 3){//拒绝
//            yishengOrder.setYishengOrderTypes();
//        }
        yishengOrderService.updateById(yishengOrder);//审核
        return R.ok();
    }
...
//                            yishengOrderEntity.setYishengOrderTime(sdf.parse(data.get(0)));          //挂号时间 要改的
//                            yishengOrderEntity.setYishengOrderTypes(Integer.valueOf(data.get(0)));   //时间类型 要改的
//                            yishengOrderEntity.setYishengOrderStatusTypes(Integer.valueOf(data.get(0)));   //挂号状态 要改的
//                            yishengOrderEntity.setYishengOrderYesnoTypes(Integer.valueOf(data.get(0)));   //挂号审核 要改的
