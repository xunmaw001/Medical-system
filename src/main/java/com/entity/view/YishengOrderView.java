...
public class YishengOrderView extends YishengOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 挂号状态的值
		*/
		private String yishengOrderStatusValue;
		/**
		* 挂号审核的值
		*/
		private String yishengOrderYesnoValue;
	...
	public YishengOrderView(YishengOrderEntity yishengOrderEntity) {
		try {
			...
			* 获取： 挂号状态的值
			*/
			public String getYishengOrderStatusValue() {
				return yishengOrderStatusValue;
			}
			/**
			* 设置： 挂号状态的值
			*/
			public void setYishengOrderStatusValue(String yishengOrderStatusValue) {
				this.yishengOrderStatusValue = yishengOrderStatusValue;
			}
			/**
			* 获取： 挂号审核的值
			*/
			public String getYishengOrderYesnoValue() {
				return yishengOrderYesnoValue;
			}
			/**
			* 设置： 挂号审核的值
			*/
			public void setYishengOrderYesnoValue(String yishengOrderYesnoValue) {
				this.yishengOrderYesnoValue = yishengOrderYesnoValue;
			}
